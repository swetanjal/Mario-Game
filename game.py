            ...
            if INPUT.checkStream():
                ...
                if x == 'd':
                    if self.__mario.jump_state == 1:
                        self.__mario.update(
                            3, Person.gravity[self.__mario.jump_idx], self.__board.left, self.__board, self.__mario)
                    else:
                        self.__mario.update(
                    ...
                    self.__mario.update(
                        0, Person.gravity[self.__mario.jump_idx], self.__board.left, self.__board, self.__mario)
